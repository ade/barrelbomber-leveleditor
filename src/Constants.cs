...
namespace GLEED2D
{
    ...
    public class Constants
    {
        ...
        public Constants()
        {
            ...
            DefaultPathItemLineWidth = 2;
            DefaultContentRootFolder = "C:\\";
            LevelFolder = Application.StartupPath;
            CameraSpeed = 500;
            ...
            GridLineThickness = 1;
            GridNumberOfGridLines = 1500;
            GridSpacing = new Microsoft.Xna.Framework.Vector2(5, 5);
        ...
        [Category("General"), Description("Workfolder, containing level files.")]
