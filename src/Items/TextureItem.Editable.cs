...
namespace GLEED2D
{
    ...
    public partial class TextureItem
    {
        ...
        public override bool loadIntoEditor()
        {
            ...
            if (layer != null) this.texture_fullpath = AdesExtensions.xmlLevelFileNameToRealFilePath(texture_filename);
            ...
            AdesExtensions.onAddTextureItem(this, this.texture_fullpath);
        ...
        {
            return GLEED2D.src.AdesExtensions.getTemplateName(this.texture_fullpath) + "_";
        }
        ...
        public Vector2 getTextureOrigin(Texture2D texture)
        {
            switch (Constants.Instance.DefaultTextureOriginMethod)
            {
                case TextureOriginMethodEnum.TextureCenter:
                    return GLEED2D.src.AdesExtensions.getTextureCenter(texture);
